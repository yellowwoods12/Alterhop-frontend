 ...
 */
export declare function getTimezoneItems(date: Date): ITimezoneItem[];
/**
 ...
 */
export declare function getInitialTimezoneItems(date: Date, includeLocalTimezone: boolean): ITimezoneItem[];
/**
