...
var TimezonePicker = /** @class */ (function (_super) {
    ...
    function TimezonePicker(props, context) {
        ...
        _this.handleItemSelect = function (timezone) { return core_1.Utils.safeInvoke(_this.props.onChange, timezone.timezone); };
        ...
        _this.timezoneItems = timezoneItems_1.getTimezoneItems(date);
        _this.initialTimezoneItems = timezoneItems_1.getInitialTimezoneItems(date, showLocalTimezone);
        return _this;
    }
    TimezonePicker.prototype.render = function () {
        ...
        var finalPopoverProps = tslib_1.__assign({}, popoverProps, { popoverClassName: classnames_1.default(Classes.TIMEZONE_PICKER_POPOVER, popoverProps.popoverClassName) });
    ...
    TimezonePicker.displayName = core_1.DISPLAYNAME_PREFIX + ".TimezonePicker";
