...
function createNamespaceNode(namespace, hierarchy, story) {
  return {
    isNamespace: true,
    name: namespace,
    namespaces: (0, _toConsumableArray2.default)(hierarchy.namespaces).concat([namespace]),
...
function ensureMainRootIsFirst(hierarchies) {
  ...
  if (mainRootIndex === -1 && hierarchies.length === 0) {
    ...
    hierarchies.unshift.apply(hierarchies, (0, _toConsumableArray2.default)(hierarchies.splice(mainRootIndex, 1)));
  }
...
function createHierarchies(stories) {
  ...
  if (stories) {
    stories.forEach(function (story) {
      ...
      fillHierarchy(namespaces, hierarchyRoot, (0, _objectSpread2.default)({}, story, {
        name: name
      }));
    });
  }
