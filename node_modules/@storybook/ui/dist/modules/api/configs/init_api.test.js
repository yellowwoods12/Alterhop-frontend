  ...
  it('should expose correct API methods', function (done) {
    ...
    var provider = {
      handleAPI: function handleAPI(api) {
        ...
        expect((0, _typeof2.default)(api.onStory)).toBe('function');
        expect((0, _typeof2.default)(api.setQueryParams)).toBe('function');
        expect((0, _typeof2.default)(api.getUrlState)).toBe('function');
        done();
      }
    };
